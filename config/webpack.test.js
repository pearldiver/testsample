...
module.exports = function(options) {
    return {
        ...
        resolve: {
             ...
             */
            extensions: ['.ts', '.js', '.adv.js', '.min.js', '.d.ts'],
        ...
        module: {
            ...
            rules: [
                ...
                {
                    test: /\.ts$/,
                    loaders: ['awesome-typescript-loader?sourceMap=false&inlineSourceMap=true&removeComments=true', 'angular2-template-loader'],
                    exclude: [/\.e2e\.ts$/]
                },
